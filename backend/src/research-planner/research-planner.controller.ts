...
import { ResearchPlannerService, CreateTaskDto, UpdateTaskDto } from './research-planner.service';
...
export class ResearchPlannerController {
  constructor(private readonly researchPlannerService: ResearchPlannerService) {}
